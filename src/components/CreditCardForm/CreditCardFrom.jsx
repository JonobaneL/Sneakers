      ...
      <div className={styles.number}>
        <CInput
          ...
          onChange={(e) => {
            ...
            e.target.value = normilzeCardNumber(value, (number) =>
              dispatch(setCardInfo({ ...checkout?.card, cardNumber: number }))
            );
          }}
        />
      </div>
      <div className={styles.date}>
        <CInput
          ...
          onChange={(e) => {
            ...
            e.target.value = normilizeDate(value, (date) =>
              dispatch(setCardInfo({ ...checkout?.card, date: date }))
            );
          }}
        />
      </div>
