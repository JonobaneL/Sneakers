...
const UserOrder = () => {
  ...
  const [isLoading, , orderInfo] = useAsync(
    () => getOrder(orderID),
    [],
    "firebase"
  );
    ...
    <div className={styles["order-info"]}>
      <div className={styles.back}>
        <Link to="/user-profile/orders">
          <span className={styles.back__icon}>&#65513;</span>Back to Orders
        </Link>
      </div>
      {isLoading ? (
        ...
        <>
          ...
          <div className={styles["order-details"]}>
            <div className={styles.column}>
              <h3 className={styles["details-title"]}>Order {orderInfo.id}</h3>
              ...
              <div className={styles.payment}>
                ...
                {orderInfo.card.cartNumber && (
                  <div className={styles.card}>
                    <p>
                      {orderInfo.card.cartNumber.match(/.{0,4}/g)?.join(" ")}
                    </p>
