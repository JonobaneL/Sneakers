    ...
    return (
        <div className={styles.tabs}>
          <div className={styles.content}>
            <div className={styles.tab} id={styles.tab1}>
                <img src="https://www.converse.com/on/demandware.static/-/Library-Sites-SharedLibrary/default/dwa57d84c7/firstspirit/media/19_landing_pages/2022_spring_5/student_discount/M-Converse-Student-Discount-LP-1.jpg" alt="converse" />
                <div className={styles.brand}>
                    <img src={converse} alt='brand' />
                </div>
            </div>
            <div className={styles.tab} id={styles.tab2}>
            ...
            <div className={styles.tab} id={styles.tab3}>
                <img src="https://footwearnews.com/wp-content/uploads/2022/10/crocs-2.jpg?w=1024" alt="" />
                <div className={styles.brand}>
                    <img src={crocs} alt='logo' />
                </div>
            </div>
            <div className={styles.tab} id={styles.tab4}>
