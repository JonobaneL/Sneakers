    ...
    <div className={styles.location}>
      ...
      <div className={styles["popular-locations"]}>
        {popularCities.map((item) => (
          <div
            key={item.id}
            className={`${styles["popular-locations__item"]} ${
              choosedCity.id === item.id ? styles.active : ""
            }`}
      ...
      <div className={styles["location-search"]}>
        <p className={styles["location-search__title"]}>
          Specify the settlement of Ukraine
        </p>
      ...
      <div className={styles["location-caption"]}>
        Choosing a city will help provide up-to-date information about available
        delivery methods in your city! This will help save more free time for
        you!
      </div>
    </div>
  );
