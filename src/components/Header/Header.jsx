...
const Header = () => {
  ...
  const [, , userInfo] = useAsync(
    () => getCurrentUser(currentUser?.uid || "s"),
    [currentUser],
    "firebase"
  );
        ...
        <div className={styles.content}>
          <ul className={styles.nav}>
            <li
              ...
              onMouseEnter={() => setHelpDropMenu(true)}
              onMouseLeave={() => setHelpDropMenu(false)}
            >
              Help
              <DropDownMenu triger={helpDropMenu}>
                <div className={styles["help-menu"]}>
                  ...
                  <ul className={styles.menu}>
                    ...
                    <li>
                      <Link to="/size-charts">Shoe Size Charts</Link>
                    </li>
                    <li>
                ...
                <DropDownMenu triger={userDropMenu}>
                  <div className={styles["help-menu"]}>
                    ...
                    <ul className={styles.menu}>
                      ...
                      <li>
                        <Link to="/user-profile/favorites">Favorites</Link>
                      </li>
                      <li>
