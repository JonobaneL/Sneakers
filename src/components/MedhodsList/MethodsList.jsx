  ...
  if (methods.length == 0) {
    return (
      <div className={styles.notice}>
        <p>
          You currently don’t have any saved payment methods. Add a method here
          to be prefilled for quicker checkout.
        </p>
      </div>
    );
  }
        ...
        return (
          <li
            ...
            className={`${styles.list__item} ${
              activeMethod == item.methodID ? styles.active : ""
            }`}
            onClick={() => {
          ...
          >
            ...
            {!triger ? null : (
              <button
                ...
                onClick={() => deleteMethod(item.methodID)}
              >
