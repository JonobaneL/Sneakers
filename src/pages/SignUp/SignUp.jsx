...
import { addNewUser } from "../../firebase/fireAuthAPI";
...
const SignUp = () => {
  ...
  const password = useInput(
    ...
    {
      isEmpty: "Password can't be blank",
  ...
  const firstName = useInput(
    "",
    { isEmpty: true },
    { isEmpty: "This field can't be blank" }
  );
  ...
  const passwordConfirm = useInput(
    "",
    { isEmpty: true, minLength: 6, isMatch: password.value },
    {
      isEmpty: "Confirm password can't be blank",
      minLength: "Password must has at least 6 characters",
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles["name-section"]}>
            <ValidationErrorMessages
              durty={firstName.isDurty}
              errorMessages={firstName.currentErrors}
            >
              <CInput
            ...
            <ValidationErrorMessages
              durty={lastName.isDurty}
              errorMessages={lastName.currentErrors}
            >
              <CInput
          ...
          <ValidationErrorMessages
            durty={city.isDurty}
            errorMessages={city.currentErrors}
          >
            <Autocomplete
              data={locationResponse}
              query={city.value}
              setQuery={(value) => city.setValue(value.name)}
            >
              <CInput
                value={city.value}
          ...
          <ValidationErrorMessages
            durty={passwordConfirm.isDurty}
            errorMessages={passwordConfirm.currentErrors}
          >
            <CInput
              id="confirmPassword"
              mode="fullBorder"
              ...
              type="password"
              valid={
                passwordConfirm.isDurty &&
                passwordConfirm.currentErrors.length > 0
              }
            />
          </ValidationErrorMessages>
          <Button
