      ...
      <div className={standartStyles.content}>
        ...
        <div className={styles.contacts}>
          ...
          <div className={styles.type}>
            ...
            <Link to="https://www.instagram.com/" className={styles.info}>
              Sneakers.ua
            </Link>
          </div>
          <div className={styles.type}>
            <img src={instagram} alt="instagram" />
            <Link to="https://www.facebook.com/" className={styles.info}>
              sneakers_ua
            </Link>
          </div>
        </div>
        ...
        <iframe
          ...
          src="https://www.google.com/maps/d/embed?mid=1L4jDyWfvatki_XKJut20PlZ8WaTw2a0&ehbc=2E312F"
        ></iframe>
      </div>
    </div>
  );
