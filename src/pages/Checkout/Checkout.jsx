...
const Checkout = () => {
  ...
  const phoneNumber = useInput(
    "",
    { isEmpty: true, minLength: 12, maxLength: 12 },
    {
  ...
  const orderValidation = checkCheckout([
    firstName.isValid,
    lastName.isValid,
    email.isValid,
    phoneNumber.isValid,
        ...
        <div className={styles["order-form"]}>
          {windowWidth <= 900 ? (
            <div className={styles.bag}>
              <Accrodion
                header={
                  <h2 className={styles["section-title"]}>In your bag</h2>
                }
                autoHeight={true}
              >
          ...
          <CheckoutShipping
            ...
            validationTirger={validationTriger}
          />
          <CheckoutPayment
            user={userInfo}
            validation={orderValidation}
