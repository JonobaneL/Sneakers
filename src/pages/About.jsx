    ...
    return <div className="About">
        <div className="content" >
           <Accordion width='180px' title={"Brands"} content={<CheckBox data={data}/>}/>
            ...
            Earum ex non harum magnam facilis excepturi quaerat amet, fugit perspiciatis, itaque, eius quo? Ullam necessitatibus id iusto ab deserunt. Ratione neque illo voluptates porro quos fugit voluptatum sit atque!
        </div>
    </div>;
}
