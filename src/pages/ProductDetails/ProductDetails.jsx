...
const ProductDetails = () => {
  ...
  const [poitedColor, setPointedColor] = useState(
    currentProduct.currentModelName
  );
  ...
  const inFavorites = useMemo(() => {
    return favorites.findIndex(
      (item) => item.productID === id && item.modelID === modelId
    );
      ...
      <div className={styles.back}>
        <div className={styles.content}>
          <img
            ...
            alt="back"
          />
          <p className={styles.back__title} onClick={backEvent}>
            Back to Results
          </p>
        </div>
      </div>
            ...
            <div className={styles["product-info"]}>
              ...
              <div className={styles["product-color"]}>
                <p className={styles.blockTitle}>
                  Color:{" "}
                  {!poitedColor ? currentProduct.currentModelName : poitedColor}
                </p>
                <ColorSelect
                  models={currentProduct.models}
                  poitedColor={(color) => setPointedColor(color)}
                />
              </div>
              {currentProduct.type !== "accessories" ? (
                <div className={styles["product-size"]}>
                  <p className={styles.blockTitle}>
                    ...
                    <span
                      hidden
                      className={styles.warringMessage}
                      ref={warning_ref}
                    >
                  ...
                  <SizeSelect
                    ...
                    choosed={productSize}
                    handler={(size_data) => setProductSize(size_data)}
                    type="single"
                  />
                </div>
              ) : (
                ...
                >
                  <div className={styles.favorite__content}>
                    ...
                    <img
                      ...
                      src={inFavorites < 0 ? heartIcon : fullHeartIcon}
                      alt="heart"
                    />
                  </div>
                </Button>
