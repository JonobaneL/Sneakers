        ...
        case "minLength":
          if (value.length < validations[item]) {
            ...
            addErrorMessage(
              currentErrors,
              setCurrentErrors,
              validationErrorMessages?.minLength || standart.minLength
            );
          } else {
            setMinLength(false);
            setCurrentErrors((p) =>
        ...
        case "maxLength":
          if (value.length > validations[item]) {
            ...
            addErrorMessage(
              currentErrors,
              setCurrentErrors,
              validationErrorMessages?.maxLength || standart.maxLength
            );
          } else {
            setMaxLength(false);
            setCurrentErrors((p) =>
          ...
          if (re.test(String(value).toLowerCase())) {
            ...
            setCurrentErrors((p) =>
              p.filter(
                (item) =>
                  item !==
                  (validationErrorMessages?.isEmail || standart.isEmail)
              )
            );
          } else {
            setEmailError(true);
          ...
          if (value === validations[item]) {
            setCurrentErrors((p) =>
              p.filter(
                (item) =>
                  item !==
                  (validationErrorMessages?.isMatch || standart.isMatch)
              )
            );
          } else {
            addErrorMessage(
          ...
          if (value) {
            ...
            setCurrentErrors((p) =>
              p.filter(
                (item) =>
                  item !==
                  (validationErrorMessages?.isEmpty || standart.isEmpty)
              )
            );
          } else {
            setIsEmpty(true);
